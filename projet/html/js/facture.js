...
{
    console.log(adresse.childNodes[0].nodeValue);
    var str = "";
    str ="étage : " + adresse.getElementsByTagName("étage")[0].childNodes[0].nodeValue;
    str += "<br/>numero: " + adresse.getElementsByTagName("numéro")[0].childNodes[0].nodeValue;
    str += "<br/>rue: " + adresse.getElementsByTagName("rue")[0].childNodes[0].nodeValue;
    str += "<br/>ville: " + adresse.getElementsByTagName("ville")[0].childNodes[0].nodeValue;
    str += "<br/>codePostal: " + adresse.getElementsByTagName("codePostal")[0].childNodes[0].nodeValue;
